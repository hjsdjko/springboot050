...
public class KechengzuoyeEntity<T> implements Serializable {
	 ...
	 * 设置：作业截止日期
	 */
	public void setZuoyejiezhiriqi(Date zuoyejiezhiriqi) {
		this.zuoyejiezhiriqi = zuoyejiezhiriqi;
	}
	/**
	 * 获取：作业截止日期
	 */
	public Date getZuoyejiezhiriqi() {
		return zuoyejiezhiriqi;
	}
	/**
	 * 设置：教师工号
	 */

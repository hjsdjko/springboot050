...
public class KechengzuoyeController {
    ...
    public R page(@RequestParam Map<String, Object> params,KechengzuoyeEntity kechengzuoye,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date zuoyejiezhiriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date zuoyejiezhiriqiend,
		...
		if(tableName.equals("jiazhang")) {
			kechengzuoye.setJiazhangzhanghao((String)request.getSession().getAttribute("username"));
		}
        ...
        EntityWrapper<KechengzuoyeEntity> ew = new EntityWrapper<KechengzuoyeEntity>();
                if(zuoyejiezhiriqistart!=null) ew.ge("zuoyejiezhiriqi", zuoyejiezhiriqistart);
                if(zuoyejiezhiriqiend!=null) ew.le("zuoyejiezhiriqi", zuoyejiezhiriqiend);

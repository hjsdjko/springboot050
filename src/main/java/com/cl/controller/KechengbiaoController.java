...
public class KechengbiaoController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		kechengbiao = kechengbiaoService.selectView(new EntityWrapper<KechengbiaoEntity>().eq("id", id));
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<KechengbiaoEntity> ew = new EntityWrapper<KechengbiaoEntity>();
        List<Map<String, Object>> result = kechengbiaoService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<KechengbiaoEntity> ew = new EntityWrapper<KechengbiaoEntity>();
        List<Map<String, Object>> result = kechengbiaoService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<KechengbiaoEntity> ew = new EntityWrapper<KechengbiaoEntity>();
        List<Map<String, Object>> result = kechengbiaoService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,KechengbiaoEntity kechengbiao, HttpServletRequest request){
        EntityWrapper<KechengbiaoEntity> ew = new EntityWrapper<KechengbiaoEntity>();
        int count = kechengbiaoService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, kechengbiao), params), params));
